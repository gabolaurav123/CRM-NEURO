...
export const DEFAULT_SETTINGS = {
  ...
  neurotrauma_price: process.env.NEUROTRAUMA_PRICE || '360',
  neurotrauma_hotmart_link: process.env.NEUROTRAUMA_HOTMART_LINK || process.env.HOTMART_LINK || 'https://pay.hotmart.com/T103515864E',
  holograficas_price: process.env.HOLOGRAFICAS_PRICE || '',
  holograficas_hotmart_link: process.env.HOLOGRAFICAS_HOTMART_LINK || process.env.HOTMART_LINK || 'https://pay.hotmart.com/T103515864E',
