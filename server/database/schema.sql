...
CREATE INDEX IF NOT EXISTS idx_conversations_crm_key ON conversations (crm_key);
CREATE INDEX IF NOT EXISTS idx_conversations_lead_crm ON conversations (lead_id, crm_key);
CREATE INDEX IF NOT EXISTS idx_messages_lead_id ON messages (lead_id);
CREATE INDEX IF NOT EXISTS idx_messages_crm_key ON messages (crm_key);
CREATE INDEX IF NOT EXISTS idx_messages_lead_crm ON messages (lead_id, crm_key);
CREATE INDEX IF NOT EXISTS idx_messages_created_at ON messages (created_at);
CREATE INDEX IF NOT EXISTS idx_payments_lead_id ON payments (lead_id);
CREATE INDEX IF NOT EXISTS idx_payments_crm_key ON payments (crm_key);
CREATE INDEX IF NOT EXISTS idx_followups_status ON followups (status);
CREATE INDEX IF NOT EXISTS idx_followups_crm_key ON followups (crm_key);
